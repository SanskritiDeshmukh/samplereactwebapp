...
class UpdateUser extends Component {
    ...
    componentDidMount() {
        UserService.getUserById(this.state.id)
            .then((res) => {
                let user = res.data;
                console.log("update page get user by id resposnse" + res.data);
                console.log("update page get user by id resposnse" + user);
                this.setState({
                    id: user.id,
    ...
    validate = () => {
        ...
        if (this.state.zip === "") {
            ...
            return false;
        } else if (this.state.zip.length < 3) {
            this.setState({ zipError: "City should have minimum 3 characters" });
            return false;
        } else {
                        ...
                        <label class="form-check-label" for="flexCheckChecked">
                          Sports
                                    ...
                                    <button
                                        ...
                                        onClick={this.updateUserInformation.bind(this)}>
                                        Update
                  </button>
